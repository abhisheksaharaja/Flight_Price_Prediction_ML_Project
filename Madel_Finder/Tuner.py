...
class MadelTuner:
    ...
    def best_param_Random_Forest(self,x_train,y_train):
        ...
        try:
            self.grid={ 'n_estimators': [f for f in range(50, 80)],
            ...
            self.log.log(self.file_object,
                               'Random Forest best params: '+str(self.rf_random.best_params_)+'. Exited the best_param_Random_Forest method of the MadelTuner class')
